...
--set custommetrics.templates.istio-prom="https://raw.githubusercontent.com/iter8/iter8-0.13.7/templates/custommetrics/istio-prom.tpl" \
...
Example providers specs:
  * [istio-prom](https://raw.githubusercontent.com/iter8/iter8-0.13.7/templates/custommetrics/istio-prom.tpl) for [Istio's Prometheus plugin](https://istio.io/latest/docs/ops/integrations/prometheus/)
...
=== "Configure values for multiple versions"
    ...
    iter8 k launch \
    --set "tasks={custommetrics,assess}" \
    --set custommetrics.templates.istio-prom="https://raw.githubusercontent.com/iter8-tools/iter8/iter8-0.13.7/templates/custommetrics/istio-prom.tpl" \
    --set custommetrics.values.labels.namespace=default \
    --set custommetrics.values.labels.destination_app=httpbin \
